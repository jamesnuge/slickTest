...
package xyz.jamesnuge.slicktest.sprites;

import org.newdawn.slick.SlickException;
import org.newdawn.slick.SpriteSheet;

public class BarneySprite extends SpriteSheet {

    public BarneySprite() throws SlickException {
        super("sprite/runningSpriteSheet.png", 50, 61);
